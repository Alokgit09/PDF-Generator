...
const SignUp = () => {
    ...
    const [fieldvalue, setFieldvValue] = useState({
        firstname: "",
        lastname: "",
        email: "",
        mobile: "",
    ...
    const handleFieldvValue = (e) => {
        setFieldvValue(prevValues => {
            return {
                ...prevValues,
    ...
    const handleFormSubmit = async () => {
        const result = await axios.post("http://localhost:9090/signup", fieldvalue);
        ...
        <>
            <div className="signUpsec">
                <div className="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
                    <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden max-w-[1200px]">
                                        ...
                                        <div className="w-1/2 px-3 mb-4">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                                    value={fieldvalue.firstname} onChange={handleFieldvValue} placeholder="John"
                                                    name="firstname" />
                                            </div>
                                        </div>
                                        <div className="w-1/2 px-3 mb-4">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith"
                                                    value={fieldvalue.lastname} onChange={handleFieldvValue} name="lastname" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex -mx-3">
                                        <div className="w-1/2 px-3 mb-4">
                                            <label htmlFor="" className="text-xs font-semibold px-1">E-Mail</label>
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                                <input type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                                    ...
                                                    value={fieldvalue.email} onChange={handleFieldvValue} name="email" />
                                            </div>
                                        </div>
                                        <div className="w-1/2 px-3 mb-4">
                                            <label htmlFor="" className="text-xs font-semibold px-1">Mobile Number</label>
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                                <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                                    placeholder="9875632546" value={fieldvalue.mobile} onChange={handleFieldvValue} name="mobile" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-4">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                                    placeholder="************" value={fieldvalue.password} onChange={handleFieldvValue} name="password" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-4">
                                            ...
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                                <input type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                                    placeholder="************" value={fieldvalue.confirmPassword} onChange={handleFieldvValue} name="confirmPassword" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-12">
                                            <label htmlFor="" className="text-xs font-semibold px-1">Full Address</label>
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                                <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                                    placeholder="Full Address" value={fieldvalue.address} onChange={handleFieldvValue} name="address" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-4">
                                            <button className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold"
                                                type="submit" onClick={handleFormSubmit} >REGISTER NOW</button>
                                            <p className="mt-4">
                                                You have Already Registered To Click <Link to="/login" className="text-indigo-500 font-semibold hover:text-indigo-700">LogIn</Link></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
