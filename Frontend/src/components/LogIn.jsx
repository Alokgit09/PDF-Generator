                    ...
                    <div className="w-full px-3 mb-4">
                      ...
                      <div className="flex">
                        ...
                        <input type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                          placeholder="************" value={password} onChange={(e) => setPassword(e.target.value)} name="password" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-4">
                      <button className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold"
                        type="submit" onClick={handleLogin} >LOGIN NOW</button>
                      <p className="mt-4">
                        Not Registered? Please <Link to="/" className="text-indigo-500 font-semibold hover:text-indigo-700">Create an Account</Link></p>
                    </div>
                  </div>
                </div>
              </div>
